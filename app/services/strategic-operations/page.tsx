      ...
      <section className="bg-white py-28">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p
            ...
            "
          >
            Strong operational systems reduce administrative bottlenecks,
            improve internal coordination, and create the structure required for
            sustainable growth. Strategic Operations helps businesses stay
            organized, efficient, and ready to scale.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <p
              ...
              "
            >
              Tell us about your business, goals, and the support you are
              looking for. Our team will review your requirements and prepare a
