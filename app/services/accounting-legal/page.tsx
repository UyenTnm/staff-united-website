...
export default function AccountingLegalPage() {
  ...
  "
          >
            Helping businesses maintain accurate financial records, improve
            operational compliance, and gain greater visibility into the
      ...
      <section className="bg-white py-28">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2
            ...
            "
          >
            Make Better Decisions with Financial Clarity
          </h2>
          ...
          <p
            ...
            "
          >
            Strong financial processes provide the visibility, accuracy, and
            confidence required to make informed business decisions. By
            maintaining organized records, consistent reporting, and reliable
            financial workflows, businesses can improve operational control,
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <p
              ...
              "
            >
              Tell us about your accounting, bookkeeping, or financial
              administration requirements. Our team will review your needs and
  ...
  "
            ...
            <textarea
              placeholder="Tell us about your bookkeeping, accounting, reporting, payroll, or financial administration requirements..."
              className="
    mt-5
    w-full
    min-h-[140px]
