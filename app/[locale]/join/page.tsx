...
import TalentFastTrackForm from "@/components/forms/TalentFastTrackForm";
...
//                   (We currently hire female employees only, as this aligns with
//                   our mission.)
//                 </p>
...
//               <p className="text-sm text-[#0b1b33]/60 mt-1">
//                 Upload your profile photo to Google Drive and paste the sharing
//                 link here. Make sure the file access is set to "Anyone with the
//                 link".
//               </p>
//             </div>
...
//             <div className="space-y-1">
//               <label className="text-sm font-medium text-[#0b1b33]">
//                 Current / Expected Role <span className="text-red-500">*</span>
//               </label>
...
//                 <label className="flex items-center gap-2 text-sm">
//                   <input type="radio" value="No" {...register("night_shift")} />
//                   No
//                 </label>
//               </div>
//             </div>
...
//           <section className="space-y-5 text-sm leading-relaxed text-[#0b1b33]/90">
...
//                 <a
//                   href="/privacy-notice"
//                   className="underline text-[#4f8fcb] hover:text-[#3a73aa] transition-colors"
//                 >
//                   Privacy Notice
//                 </a>
//               </span>
...
//                 professional profile information on the STAFF United website so
//                 clients can review potential candidates.
//               </span>
//             </label>
//           </section>
...
//           {/* modal */}
//           <div className="relative bg-white rounded-2xl p-8 max-w-md w-full text-center shadow-[0_20px_60px_rgba(0,0,0,0.2)]">
...
//               className="px-6 py-2 bg-[#0b1b33] text-white rounded-md hover:bg-[#0b1b33]/90 transition"
//             >
//               Close
//             </button>
//           </div>
